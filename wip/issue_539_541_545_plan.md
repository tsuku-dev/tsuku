...
- [ ] Create make.toml recipe using homebrew_bottle
- [ ] Create gdbm.toml recipe with homebrew_source + configure_make
- [ ] Create build-essentials.yml CI workflow with 4-platform matrix
- [ ] Run local tests to verify recipes work
