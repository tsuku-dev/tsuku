...
func touchAutogeneratedFiles(sourceDir string) {
	// List of autogenerated files to touch
	files := []string{
		"configure",
		"aclocal.m4",
		"config.h.in",
	...
	// Touch all autogenerated files recursively
	// This includes Makefile.in, .texi (texinfo source), and .info (generated docs)
	_ = filepath.Walk(sourceDir, func(path string, info os.FileInfo, err error) error {
		...
		name := info.Name()
		// Touch Makefile.in, .texi, and .info files to prevent regeneration
